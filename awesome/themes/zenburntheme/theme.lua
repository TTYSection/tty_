...
theme.dir                           			= os.getenv("HOME") .. "/.config/awesome/themes/zenburntheme"
theme.wallpaper                     			= theme.dir .. "/think_correctly.jpg"


--theme.wallpaper_cmd 							= { "/usr/bin/nitrogen --restore" }
--theme.wallpaper_cmd 							= { "awsetbg -a .config/awesome/themes/zenburntheme/think_correctly.jpg" }
